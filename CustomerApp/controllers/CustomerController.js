const connectionPool = require('../db/DatabaseConnection.js');
const { param } = require('../routes/CustomerRoutes.js');
...
module.exports = {
   initializeUi, findCustomers, newCustomerForm, createCustomer, updateCustomerForm, modifyCustomer, deleteCustomer
}